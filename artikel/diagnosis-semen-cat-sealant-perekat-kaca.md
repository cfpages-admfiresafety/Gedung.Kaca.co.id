---
article_id: GED-02-04
title: "Mengenali Sisa Semen, Cat, Sealant, dan Perekat pada Kaca"
slug: "diagnosis-semen-cat-sealant-perekat-kaca"
...
date_modified: null
parent_topic: GED-02
primary_intent: "Mengidentifikasi kontaminan pekerjaan konstruksi sebelum dibersihkan."
reader_community: "Kaca.co.id"
reader_address: "Teman Kaca.co.id"
final_route: "/artikel/diagnosis-semen-cat-sealant-perekat-kaca.html"
...
# Mengenali Sisa Semen, Cat, Sealant, dan Perekat pada Kaca

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mengenali Sisa Semen, Cat, Sealant, dan Perekat pada Kaca”
...
- **Primary intent:** Mengidentifikasi kontaminan pekerjaan konstruksi sebelum dibersihkan.
...
- **Scope boundary:** Berfokus pada jenis residu; risiko scraper dan bahan kimia dibahas di GED-03.
- **Final public route:** `/artikel/diagnosis-semen-cat-sealant-perekat-kaca.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mengenali Sisa Semen, Cat, Sealant, dan Perekat pada Kaca**.
...
- `GED-02-02` → `/artikel/diagnosis-noda-air-kerak-mineral-kaca.html` — Noda Air dan Kerak Mineral pada Kaca: Ciri dan Uji Awal
- `GED-02-03` → `/artikel/diagnosis-jamur-lumut-biofilm-kaca.html` — Jamur, Lumut, atau Biofilm di Area Kaca dan Frame?
- `GED-02-05` → `/artikel/diagnosis-kabut-antar-lapisan-kaca.html` — Kabut di Permukaan atau di Antara Lapisan Kaca?
- `GED-02-06` → `/artikel/diagnosis-goresan-etching-kerusakan-coating.html` — Goresan, Etching, dan Kerusakan Coating: Cara Membedakan
...
- **Tie back to this article:** Keep the explanation specific to “Mengenali Sisa Semen, Cat, Sealant, dan Perekat pada Kaca”.
