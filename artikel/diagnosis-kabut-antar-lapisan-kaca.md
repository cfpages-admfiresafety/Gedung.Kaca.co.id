---
article_id: GED-02-05
title: "Kabut di Permukaan atau di Antara Lapisan Kaca?"
slug: "diagnosis-kabut-antar-lapisan-kaca"
...
date_modified: null
parent_topic: GED-02
primary_intent: "Menentukan apakah haze dapat dijangkau dari permukaan atau mengindikasikan kegagalan unit."
reader_community: "Kaca.co.id"
reader_address: "Sobat Kaca.co.id"
final_route: "/artikel/diagnosis-kabut-antar-lapisan-kaca.html"
...
# Kabut di Permukaan atau di Antara Lapisan Kaca?

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kabut di Permukaan atau di Antara Lapisan Kaca?”
...
- **Primary intent:** Menentukan apakah haze dapat dijangkau dari permukaan atau mengindikasikan kegagalan unit.
...
- **Scope boundary:** Membedakan lokasi gejala; keputusan perbaikan sistem glazing harus dievaluasi ahli pada GED-07.
- **Final public route:** `/artikel/diagnosis-kabut-antar-lapisan-kaca.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kabut di Permukaan atau di Antara Lapisan Kaca?**.
...
- **Tie back to this article:** Keep the explanation specific to “Kabut di Permukaan atau di Antara Lapisan Kaca?”.
