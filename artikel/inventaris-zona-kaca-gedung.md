---
article_id: GED-01-02
title: "Cara Membuat Inventaris Zona Kaca, Orientasi, dan Tingkat Akses"
slug: "inventaris-zona-kaca-gedung"
...
date_modified: null
parent_topic: GED-01
primary_intent: "Memetakan bidang kaca menjadi zona kerja yang dapat dinilai."
reader_community: "Kaca.co.id"
reader_address: "Kawan Kaca.co.id"
final_route: "/artikel/inventaris-zona-kaca-gedung.html"
...
# Cara Membuat Inventaris Zona Kaca, Orientasi, dan Tingkat Akses

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Cara Membuat Inventaris Zona Kaca, Orientasi, dan Tingkat Akses”
...
- **Primary intent:** Memetakan bidang kaca menjadi zona kerja yang dapat dinilai.
...
- **Scope boundary:** Berfokus pada pemetaan aset; kondisi noda didiagnosis di GED-02 dan frekuensi perawatan di GED-08.
- **Final public route:** `/artikel/inventaris-zona-kaca-gedung.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cara Membuat Inventaris Zona Kaca, Orientasi, dan Tingkat Akses**.
...
- `GED-01-01` → `/artikel/checklist-survei-awal-kaca-gedung.html` — Checklist Survei Awal Kaca Gedung Sebelum Meminta Penawaran
...
- **Tie back to this article:** Keep the explanation specific to “Cara Membuat Inventaris Zona Kaca, Orientasi, dan Tingkat Akses”.
