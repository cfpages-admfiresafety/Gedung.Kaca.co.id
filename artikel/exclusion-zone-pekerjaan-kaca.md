---
article_id: GED-06-03
title: "Exclusion Zone dan Perlindungan Publik di Bawah Area Kerja"
slug: "exclusion-zone-pekerjaan-kaca"
...
date_modified: null
parent_topic: GED-06
primary_intent: "Merencanakan pembatasan, pengalihan, komunikasi, dan risiko benda jatuh."
reader_community: "Kaca.co.id"
reader_address: "Sobat Kaca.co.id"
final_route: "/artikel/exclusion-zone-pekerjaan-kaca.html"
...
# Exclusion Zone dan Perlindungan Publik di Bawah Area Kerja

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Exclusion Zone dan Perlindungan Publik di Bawah Area Kerja”
...
- **Primary intent:** Merencanakan pembatasan, pengalihan, komunikasi, dan risiko benda jatuh.
...
- **Scope boundary:** Khusus perlindungan area bawah; akses teknis di façade dimiliki GED-05.
- **Final public route:** `/artikel/exclusion-zone-pekerjaan-kaca.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Exclusion Zone dan Perlindungan Publik di Bawah Area Kerja**.
...
- `GED-06-01` → `/artikel/rencana-keselamatan-pekerjaan-kaca-ketinggian.html` — Elemen Wajib Rencana Keselamatan Pekerjaan Kaca di Ketinggian
- `GED-06-02` → `/artikel/verifikasi-anchor-fall-protection-peralatan.html` — Bukti Anchor, Fall Protection, dan Peralatan yang Perlu Diverifikasi
- `GED-06-04` → `/artikel/rescue-plan-pekerjaan-di-ketinggian.html` — Rescue Plan Bukan Sekadar Nomor Telepon Darurat
- `GED-06-05` → `/artikel/batas-cuaca-pekerjaan-kaca-ketinggian.html` — Hujan, Angin, Petir, dan Panas: Kapan Pekerjaan Harus Ditunda?
...
- **Tie back to this article:** Keep the explanation specific to “Exclusion Zone dan Perlindungan Publik di Bawah Area Kerja”.
